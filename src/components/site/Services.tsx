...
export function Services() {
  ...
  const services = [
    { title: t("svc_1_title"), desc: t("svc_1_desc"), img: svc1 },
    { title: t("svc_2_title"), desc: t("svc_2_desc"), img: svc2 },
    { title: t("svc_3_title"), desc: t("svc_3_desc"), img: svc3 },
    { title: t("svc_4_title"), desc: t("svc_4_desc"), img: svc4 },
    { title: t("svc_5_title"), desc: t("svc_5_desc"), img: svc5 },
    { title: t("svc_6_title"), desc: t("svc_6_desc"), img: svc6 },
    { title: t("svc_7_title"), desc: t("svc_7_desc"), img: svc7 },
    { title: t("svc_8_title"), desc: t("svc_8_desc"), img: svc8 },
  ];
